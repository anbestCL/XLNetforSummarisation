...
def _run():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The input training data_original file (a text file).",
    )
    parser.add_argument(
        "--output_dir",
        default=None,
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="Run model evaluation on out-of-sample data_original.",
    )
    ...
    parser.add_argument(
        ...
        default=4,
        type=int,
        help="Number of workers for data_original loading",
    )
    parser.add_argument(
        "--max_seqlen",
        type=int,
    ...
    if FLAGS['do_train']:
        logger.info("***** Running training *****")
        tr_losses, dev_scores, best_dev_score = _train(device, model, tokenizer, train_paths, dev_paths)
